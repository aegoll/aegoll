...
class Governor:
    ...
    def __init__(
        ...
        *,
        ...
        self.inference = InferenceGate(self.aegl)
    ...
    def authorize_run(
        ...
        *,
        ...
        self.aegl.audit.labels.setdefault("provider", provider)
    ...
    def register_identity(
        ...
        *,
        ...
        """
        return self.aegl.identities.register(
            agent_id=agent_id or self.aegl.agent_id,
            purpose=purpose,
    ...
    def declare_intent(
        ...
        *,
        ...
        """
        return self.aegl.intents.declare(
            agent_id=self.aegl.agent_id,
            purpose=purpose,
    ...
    def active_intent(self) -> Any | None:
        return self.aegl.intents.active_for(self.aegl.agent_id, self.aegl.clock.now())

    def revoke_intent(self, intent_id: str) -> bool:
        """Withdraw authority without deleting the record of it having been granted."""
        return self.aegl.intents.revoke(intent_id)
    ...
    def precheck_run(
        ...
        """
        request = self.aegl.build_request(
        ...
        decision = self.aegl.decide(request)
    ...
    def record_override(self, precheck: dict[str, Any], seconds_left: float = 0.0) -> None:
        ...
        self.aegl.audit.attach_settlement(
            request_id,
            {
                "type": "human_override",
    ...
    def wrap(self, client: Any, *, vendor: Vendor | None = None) -> Any:
        ...
        governed = GovernedBuyer(self.aegl, client, vendor=vendor or self.seller)
...
class _RecordingBuyer:
    ...
    async def get_paid(self, path: str) -> Any:
        before = len(self._gov.aegl.audit.entries())
        try:
            ...
            raise
        for entry in self._gov.aegl.audit.entries()[before:]:
