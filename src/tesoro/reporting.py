...
`tesoro report`, `tesoro report --json`, the HTML page and the localhost read API all
...
#: archived — the journal is the archive, and `tesoro audit` reads it in full.
DEFAULT_LIMIT = 50
